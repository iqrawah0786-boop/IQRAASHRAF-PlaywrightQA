...
Structure the report as: test-results/SCRUM-101.md 
...
https://github.com/iqrawah0786-boop/IQRAASHRAF-PlaywrightQA.git 

## Prompt: 
Now I need to commit all the test artifacts to the Git repository using the GitHub MCP server. 
Git Repository URL: https://github.com/iqrawah0786-boop/IQRAASHRAF-PlaywrightQA.git 
...
STEP 1 - READ USER STORY: 
First, read the user story from: user-stories/SCRUM-101.md 
...
STEP 6 - CREATE TEST REPORT: 
Create a comprehensive test execution report at: test-results/SCRUM.md 
